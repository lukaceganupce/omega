...
class Response
{
    ...
    public function send($body = null)
    {
        ...
        if ($dispatcher = $this->getDispatcher()) {
            $responseEvent = new Event('response.send.pre');
            $dispatcher->dispatch('response.send.pre', $responseEvent);
        }
        ...
        //response.send.post
        if ($dispatcher = $this->getDispatcher()) {
            $responseEvent = new Event('response.send.post');
            $dispatcher->dispatch('response.send.post', $responseEvent);
        }
    ...
    {
        return isset($this->dispatcher) ? $this->dispatcher : false;
    }
